...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=DESKTOP-H3UQ96M\SQLEXPRESS;Initial Catalog=SOF2052_PolyCafe;Integrated Security=True;Trust Server Certificate=True";
